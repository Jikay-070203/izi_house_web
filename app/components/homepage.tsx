        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            ...
            <div className="flex flex-col items-center">
              <div className="bg-white p-3 md:p-4 rounded-xl shadow-lg mb-3 md:mb-4">
                <Image
                  src="/QR/QR.png"
              ...
              <div className="text-center text-white">
                <p className="font-semibold text-sm md:text-base mb-1">Quét mã QR để tải ứng dụng</p>
                <p className="text-blue-200 text-xs md:text-sm">Hỗ trợ iOS & Android</p>
              </div>
            </div>
          </div>
        </div>
